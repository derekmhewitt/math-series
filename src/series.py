...
if __name__ == '__main__':
    ...
    print(u"""The first function this module contains outputs the value of
        the nth Fibonacci number. This is the output of the Fibonacci
        function called with n = 7:""")
    print(u">>> fibonacci(7)")
    print(fibonacci(7))
    print(u"""The second function this module contains outputs the value of
        the nth Lucas number. This is the output of the Lucas function called
        with n = 5:""")
    print(u">>> lucas(5)")
    print(lucas(5))
    print(u"""The thrid and final function in this module outputs the value of
        the nth number in Fibonacci or Lucas -like sequence defined by the
        user with it's second and third arguments. This is the output of the
        sum_series function called with n = 3, a = 5 and b = 7:""")
    print(u">>> sum_series(3, 5, 7)")
    print(sum_series(3, 5, 7))
    print(u"""You can also execute sum_series with just an n argument and it
        will default to a Fibonacci number output:""")
